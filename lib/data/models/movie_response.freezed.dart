...
mixin _$MovieResponse {
  ...
  List<MovieResults> get results => throw _privateConstructorUsedError;
...
abstract class $MovieResponseCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'total_results') int total_results});
}
...
class _$MovieResponseImpl implements _MovieResponse {
  const _$MovieResponseImpl(
      {required this.page,
      required final List<MovieResults> results,
      @JsonKey(name: 'total_pages') required this.total_pages,
      @JsonKey(name: 'total_results') required this.total_results})
      : _results = results;
  ...
  @override
  String toString() {
    return 'MovieResponse(page: $page, results: $results, total_pages: $total_pages, total_results: $total_results)';
  }
...
abstract class _MovieResponse implements MovieResponse {
  const factory _MovieResponse(
          ...
          required final List<MovieResults> results,
          @JsonKey(name: 'total_pages') required final int total_pages,
          @JsonKey(name: 'total_results') required final int total_results}) =
      _$MovieResponseImpl;
